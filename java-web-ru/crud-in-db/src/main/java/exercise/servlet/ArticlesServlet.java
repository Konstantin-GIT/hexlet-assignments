...
public class ArticlesServlet extends HttpServlet {
    ...
    private void createArticle(HttpServletRequest request,
        ...
        try {
            PreparedStatement preparedStatement =
                    connection.prepareStatement("INSERT INTO articles (title, body) VALUES ( ?, ?);");
    ...
    private void updateArticle(HttpServletRequest request,
        ...
        try {
            PreparedStatement statement =
                    connection.prepareStatement("UPDATE articles SET title=?, body=? WHERE id=?");
    ...
    private void destroyArticle(HttpServletRequest request,
        ...
        // BEGIN
        try {
            PreparedStatement statement = connection.prepareStatement("DELETE articles WHERE id=?;");
            statement.setString(1, id);
