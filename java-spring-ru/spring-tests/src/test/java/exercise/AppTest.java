...
public class AppTest {
    ...
    void testUpdatePerson() throws Exception {
        ...
        PersonDto dto = new PersonDto();
        dto.setFirstName("NewJackson");
        dto.setLastName("NewBind");
        dto.setEmail("jack_NEW_@mail.com");
        ...
        // Проверяем статус ответа
        assertThat(response.getStatus()).isEqualTo(200);
        // Проверяем, что сущность обновилась в базе
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).contains("NewJackson", "NewBind");

        assertNotNull(repository.findByEmail("jack_NEW_@mail.com"));
        assertThat(repository.findById(existingUserId).getEmail().equals("jack_NEW_@mail.com"));
    }
    ...
    void testDeletePerson() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).doesNotContain("john@gmail.com");
        // Проверяем, что сущность удалилась из базы
